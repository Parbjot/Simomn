...
const int BUTTON_PIN_L = 5;     // Left button pin
const int BUTTON_PIN_R = 9;     // Right button pin
const int SPEAKER_PIN = 7;      // Speaker pin
const int LED_PIN_L =13;       // Left LED pin
const int LED_PIN_R = 3;       // Right LED pin

static int Level = 5;  // Initial game level
